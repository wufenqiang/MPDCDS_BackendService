...
var commonInitialisms = []string{"ACL", "ASCII", "CPU", "CSS", "DNS", "EOF", "GUID", "HTML", "HTTP", "HTTPS", "ID", "IP", "JSON", "LHS", "QPS", "RAM", "RHS", "RPC", "SLA", "SMTP", "SQL", "SSH", "TCP", "TLS", "TTL", "UDP", "UI", "UID", "UUID", "URI", "URL", "UTF8", "VM", "XML", "XMPP", "XSRF", "XSS"}

//var commonInitialisms = []string{"API"}
...
/*
	...
	首字母大写，“_” 忽略后大写
*/
func private_Marshal0(name string) string {
	if name == "" {
		return ""
	}
...
/*
 回退网络模式
*/
func private_UnMarshal0(name string) string {
	const (
		lower = false
		upper = true
	)
...
func private_Marshal1(i interface{}) string {
	s := reflect.TypeOf(i).Name()
	return private_Marshal0(s)
}
func private_UnMarshal1(i interface{}) string {
	s := reflect.TypeOf(i).Name()
	return private_UnMarshal0(s)
}

func Marshal(s string) string {
	return private_Marshal0(s)
}
func UnMarshal(i interface{}) string {
	return private_UnMarshal1(i)
}
